...
symmetric = "-3 euro, -1 euro, +1 euro, +3 euro"
...
filtered_df = filtered_df[(filtered_df['Period'] >= 1) & (filtered_df['Period'] <= 1)]
...
for index, row in filtered_df.iterrows():
        ...
        if valuation < 0:
            if row['treatment_number'] == 'symmetric':
                if row['Rule_1'] == "SM":
                    if row["Rule_2"] == "AGV":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {symmetric}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_without_explanation}"
                        elif explanation == 1:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {symmetric}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_with_explanation}"
                    elif row["Rule_2"] == "NSQ":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {symmetric}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {NSQ} \n {end_without_explanation}"
                        elif explanation == 1:
                ...
                if row['Rule_1'] == "SM":
                    if row["Rule_2"] == "AGV":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {right_skewed}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_without_explanation}"
                        elif explanation == 1:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {right_skewed}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_with_explanation}"
                    elif row["Rule_2"] == "NSQ":
                        if explanation == 0:
                ...
                if row['Rule_1'] == "SM":
                    if row["Rule_2"] == "AGV":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {left_skewed}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_without_explanation}"
                        elif explanation == 1:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {left_skewed}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_with_explanation}"
                    elif row["Rule_2"] == "NSQ":
                        if explanation == 0:
                ...
                if row['Rule_1'] == "SM":
                    if row["Rule_2"] == "AGV":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {robustness}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_without_explanation}"
                        elif explanation == 1:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {robustness}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you have to pay if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_with_explanation}"
                    elif row["Rule_2"] == "NSQ":
                        if explanation == 0:
        ...
        if valuation > 0:
            if row['treatment_number'] == 'symmetric':
                if row['Rule_1'] == "SM":
                    if row["Rule_2"] == "AGV":
                        if explanation == 0:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {symmetric}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you benefit if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_without_explanation}"
                        elif explanation == 1:
                            input_text = f"{introduction_ad_interim} the valuation of each group member can be {symmetric}. All values are equally likely \n Your private valuation is {valuation} euro, indicating that you benefit if the project is implemented \n Rule 1 = {SM} \n Rule 2 = {AGV} \n {end_with_explanation}"
                    elif row["Rule_2"] == "NSQ":
                        if explanation == 0:
    ...
    filtered_df.at[index, "input_text"] = message_history
    if explanation == 1:
...
for index, row in filtered_df.iterrows():
    ...
    if group_mechanism == "SM":
        if explanation == 1:
            if valuation > 0:
                message_history.append(
                    {"role": "user", "content": f"Your valuation for Project A is positive, amounting to +{valuation}, meaning you will gain financially if the project is implemented"
                                                "The final decision rule is SM. Will you vote in favor or against? Please respond with 1 for in favor and 0 for against, and briefly explain your decision in one sentence"})

            elif valuation < 0:
                message_history.append(
                    {"role": "user", "content": f"Your valuation for Project A is negative, amounting to {valuation}, meaning you will lose financially if the project is implemented"
                                                "The final decision rule is SM. Will you vote in favor or against? Please respond with 1 for in favor and 0 for against, and briefly explain your decision in one sentence"})
        elif explanation == 0:
            if valuation > 0:
                message_history.append(
                    {"role": "user", "content": f"Your valuation for Project A is positive, amounting to +{valuation}, meaning you will gain financially if the project is implemented"
                                                "The final decision rule is SM. Will you vote in favor or against? Please respond with 1 for in favor and 0 for against"})
            elif valuation < 0:
                message_history.append(
                    {"role": "user", "content": f"Your valuation for Project A is negative, amounting to {valuation}, meaning you will lose financially if the project is implemented"
                                                "The final decision rule is SM. Will you vote in favor or against? Please respond with 1 for in favor and 0 for against"})
        ...
        if explanation == 1:
            if valuation > 0:
                message_history.append(
                    {"role": "user", "content": f"your private valuation is positive, amounting to +{valuation} euro, meaning you will gain financially if the project is implemented"
                                                "The final decision rule is AGV. Please provide your stated valuation and explain your reasoning. Remember that the sum of stated valuations determines whether to implement the project, but your payoff is based on your private valuation."})
            elif valuation < 0:
                message_history.append(
                    {"role": "user", "content": f"your private valuation is positive, amounting to +{valuation} euro, meaning you will lose financially if the project is implemented"
                                                "The final decision rule is AGV. Please provide your stated valuation and explain your reasoning. Remember that the sum of stated valuations determines whether to implement the project, but your payoff is based on your private valuation."})
            ...
            if valuation > 0:
                message_history.append(
                    {"role": "user", "content": f"your private valuation is positive, amounting to +{valuation} euro, meaning you will gain financially if the project is implemented"
                                                "The final decision rule is AGV. Please provide your stated valuation. Remember that the sum of stated valuations determines whether to implement the project, but your payoff is based on your private valuation."})
            elif valuation < 0:
                message_history.append(
                    {"role": "user", "content": f"your private valuation is positive, amounting to +{valuation} euro, meaning you will lose financially if the project is implemented"
                                                "The final decision rule is AGV. Please provide your stated valuation. Remember that the sum of stated valuations determines whether to implement the project, but your payoff is based on your private valuation."})
...
filtered_df.to_csv('RUN3.csv', index=False)
