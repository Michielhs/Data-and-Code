...
with open('Explanations/RUN2_introduction Ex Ante.txt', 'r') as file:
    # Read the contents
    contents = file.read()

introduction_ex_ante = contents

with open('Explanations/RUN2_introduction Ad Interim.txt', 'r') as file:
    # Read the contents
    contents = file.read()

introduction_ad_interim = contents

with open('Explanations/RUN2_end with explanation.txt', 'r') as file:
    # Read the contents
    contents = file.read()

end_with_explanation = contents

with open('Explanations/RUN2_end without explanation.txt', 'r') as file:
    # Read the contents
    contents = file.read()
...
# General introduction text
with open('Explanations/RUN2_AGV.txt', 'r') as file:
    # Read the contents
    contents = file.read()
...
# General introduction text
with open('Explanations/RUN2_NSQ.txt', 'r') as file:
    # Read the contents
    contents = file.read()
...
# General introduction text
with open('Explanations/RUN2_RAND.txt', 'r') as file:
    # Read the contents
    contents = file.read()
...
# General introduction text
with open('Explanations/RUN2_SM.txt', 'r') as file:
    # Read the contents
    contents = file.read()
...
filtered_df.to_csv('RUN2.csv', index=False)
