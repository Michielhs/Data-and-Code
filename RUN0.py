# set starting time calcute running time
import time
start_time = time.time()

# code part 1: dials --> select model
...
# code part 2: setting up the environment
...
# set your OpenAI API key [insert key here]
OPENAI_API_KEY = ""
...
# code part 3: import and load variables

# Load the instructions of the experiment
...
# Part 5: Get choice mechanism (part 1)
...
# Code part 6: Apply the mechanism (Part 2)
...
filtered_df.to_csv('RUN0.csv', index=False)
